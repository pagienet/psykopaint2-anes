...
public class GoViralExample extends Sprite
{
	...
	public function showMainUI():void
	{
		...
		layout.layout();	
		log("Main UI displayed. "+GoViral.VERSION);
	}
	...
	public function showFacebookUI():void
	{
		...
		layout.addButton(new SimpleButton(new Command("Like Us", likePageFacebook)));
		...
		layout.addButton(new SimpleButton(new Command("App Events", logFacebookEvents)));
		layout.addButton(new SimpleButton(new Command("Request Ad ID", requestFacebookAdId)));
		layout.addButton(new SimpleButton(new Command("Post High Score", submitFacebookScore)));
		layout.addButton(new SimpleButton(new Command("Post Achievement", submitFacebookAchievement)));
...
class SimpleButton extends Sprite
{
	...
	public function SimpleButton(cmd:Command)
	{
		...
		txtLabel.defaultTextFormat=new TextFormat("Arial",33,0xFFFFFF);
